  ...
  return (
    <div className="max-w-screen-xl px-6 mx-auto lg:px-8">
      <div className="py-10 pb-0">
        ...
        <p className="text-lg leading-relaxed mt-4 text-neutral-700 tracking-wide leading-relaxed indent-5">
        ...
        <p className="text-lg leading-relaxed mt-8 text-neutral-700 tracking-wide leading-relaxed indent-5">
